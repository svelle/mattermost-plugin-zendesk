...
func (h *Handler) handleTicket(args *model.CommandArgs, ticketIDStr string) (*model.CommandResponse, error) {
	...
	if err != nil {
		...
		return ephemeral(fmt.Sprintf("Failed to get ticket #%d.", ticketID)), nil
	}
...
func (h *Handler) handleSearch(args *model.CommandArgs, query string) (*model.CommandResponse, error) {
	...
	if err != nil {
		h.client.Log.Error("Ticket search failed", "query", query, "error", err.Error())
		return ephemeral("Search failed."), nil
	}
...
func (h *Handler) handleArticle(args *model.CommandArgs, query string) (*model.CommandResponse, error) {
	...
	if err != nil {
		h.client.Log.Error("Article search failed", "query", query, "error", err.Error())
		return ephemeral("Article search failed."), nil
	}
...
func (h *Handler) handleSubscribe(args *model.CommandArgs, rawArgs string) (*model.CommandResponse, error) {
	...
	if err := h.store.StoreSubscription(sub); err != nil {
		h.client.Log.Error("Failed to create subscription", "channel_id", args.ChannelId, "error", err.Error())
		return ephemeral("Failed to create subscription."), nil
	}
...
func (h *Handler) handleUnsubscribe(args *model.CommandArgs) (*model.CommandResponse, error) {
	...
	if err := h.store.DeleteSubscription(args.ChannelId); err != nil {
		h.client.Log.Error("Failed to remove subscription", "channel_id", args.ChannelId, "error", err.Error())
		return ephemeral("Failed to remove subscription."), nil
	}
